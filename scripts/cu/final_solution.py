...
def create_sap_data():
    """إنشاء بيانات SAP مع الحقول المطلوبة"""
    try:
        ...
        print("=== الحل النهائي: إنشاء بيانات SAP ===")
        
        # 1. Create customers with all required fields
                ...
                if existing:
                    ...
                    cur.execute("""
                        INSERT INTO res_partner (
                            ...
                            autopost_bills, group_rfq, group_supplier, 
                            create_uid, write_uid, create_date, write_date
                        ) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, NOW(), NOW())
                        RETURNING id;
                    """, (customer_name, True, 1, 0, 'auto', 1, 1, 2, 2))
        ...
        cur.execute("""
            SELECT pt.name, s.sap_product_id, s.sync_status
