...
export class PosPerfumeScreen extends Component {
    ...
    setup() {
        ...
        this.state = useState({
            ...
            // UI state
            loading: false,
            exchangeRate: 1540,  // Default, should be loaded from settings
        });
    ...
    onSelectCustomer(customer) {
        if (customer) {
            ...
            this.state.currentOrder.pricelist_id = customer.pricelist_id || null;
            ...
            this.state.currentOrder.pricelist_id = null;
        }
    }
