                  ...
                  <CardContent className="p-3">
                    <div className="flex items-start gap-3">
                      <div className="relative shrink-0">
                        ...
                        <span className={`absolute -bottom-0.5 -left-0.5 text-[10px] w-4 h-4 rounded-full ${channel.bg} flex items-center justify-center`}>
                          {channel.icon}
                        </span>
                      </div>
            ...
            <Card className="border-border/50 h-full flex flex-col">
              ...
              <div className="flex-1 p-4 space-y-4 min-h-[200px] max-h-[400px] overflow-y-auto">
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    <div className="bg-secondary/50 rounded-2xl rounded-tr-sm p-3 max-w-md">
