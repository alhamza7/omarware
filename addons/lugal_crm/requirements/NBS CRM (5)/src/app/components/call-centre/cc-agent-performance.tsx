                ...
                return (
                  ...
                  >
                    ...
                    <div className="relative shrink-0">
                      ...
                      <span className={`absolute -bottom-0.5 -right-0.5 w-2.5 h-2.5 rounded-full ${statusColors[agent.status]} border-2 border-card`} />
                    </div>
                    ...
                    <CardContent className="p-4">
                      ...
                      <div className="flex items-center gap-3 mb-4">
                        <div className="relative shrink-0">
                          ...
                          <span className={`absolute -bottom-0.5 -right-0.5 w-3 h-3 rounded-full ${statusColors[agent.status]} border-2 border-card`} />
                        </div>
