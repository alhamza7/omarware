import { Home, Users, ShoppingBag, Package, Settings, BarChart3, Headset, BookMarked } from "lucide-react";
...
export function Sidebar({ activeTab, onTabChange }: SidebarProps) {
  ...
  return (
    <aside className="w-64 bg-sidebar border-l border-sidebar-border flex flex-col relative overflow-hidden">
      ...
      <div className="p-4 border-t border-sidebar-border relative z-10">
        ...
        >
          ...
          <p className="text-sm font-semibold text-primary relative z-10">v1.0.0</p>
        </motion.div>
      </div>
    </aside>
  );
