  ...
  return (
    ...
    >
      ...
      >
        {/* Ambient Glows */}
        <div
          className={`absolute top-0 right-0 w-[600px] h-[600px] rounded-full blur-[140px] -mr-48 -mt-48 pointer-events-none transition-colors duration-500
            ${isDark ? "bg-yellow-500/5" : "bg-cyan-500/5"}
        `}
        />
        <div
          className={`absolute bottom-0 left-0 w-[400px] h-[400px] rounded-full blur-[120px] -ml-32 -mb-32 pointer-events-none transition-colors duration-500
        ...
        >
          ...
          <div className="flex flex-col items-start gap-1 text-right w-full md:w-auto">
            <CardTitle
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className={`absolute top-0 left-0 w-[400px] h-[400px] rounded-full blur-[120px] -ml-48 -mt-48 pointer-events-none transition-colors duration-500
            ${isDark ? "bg-yellow-500/5" : "bg-cyan-500/5"}
        `}
        />
        <div
          className={`absolute bottom-0 right-0 w-[300px] h-[300px] rounded-full blur-[100px] -mr-32 -mb-32 pointer-events-none transition-colors duration-500
        ...
        >
          ...
          <CardDescription
            className={`text-right font-medium transition-colors duration-500
                ${isDark ? "text-zinc-400" : "text-slate-500"}
            `}
          >
