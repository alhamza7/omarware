            ...
            <table className="w-full text-xs">
              <thead>
                <tr className="border-b border-border/40 bg-muted/20">
                  ...
                  <th className="text-right p-3">مفتوحة</th>
                  <th className="text-right p-3">مغلقة</th>
                  <th className="text-right p-3">متأخرة / راكدة</th>
                  <th className="text-right p-3">الإجمالي</th>
                  <th className="text-right p-3">نسبة الإغلاق</th>
                </tr>
              </thead>
              <tbody>
