            ...
            <Table>
              <TableHeader className="bg-muted/30">
                <TableRow className="hover:bg-transparent border-border/40">
                  <TableHead className="text-start w-[50px]">النوع</TableHead>
                  <TableHead className="text-start">العميل</TableHead>
                  <TableHead className="text-start hidden md:table-cell">الوكيل</TableHead>
                  <TableHead className="text-start hidden md:table-cell">الموضوع</TableHead>
                  <TableHead className="text-start hidden lg:table-cell">التاريخ</TableHead>
                  <TableHead className="text-start">المدة</TableHead>
                  <TableHead className="text-start hidden lg:table-cell">التقييم</TableHead>
                    ...
                    >
                      ...
                      <TableCell className="hidden lg:table-cell">
                        <div className="text-xs text-muted-foreground">
                          ...
                          <p dir="ltr" className="text-start">{record.time}</p>
                        </div>
                      </TableCell>
                      <TableCell>
