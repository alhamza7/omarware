    ...
    <AnimatePresence>
      {visible && (
        <motion.div
          ...
          className="fixed top-6 start-1/2 -translate-x-1/2 z-[100] w-[420px] max-w-[95vw]"
        >
          {/* Outer glow */}
            ...
            <div className="p-5">
              ...
              <div className="flex items-center gap-4 mb-5">
                ...
                <div className="relative">
                  ...
                  {customer.vip && (
                    <div className="absolute -top-1 -end-1 z-20 w-6 h-6 rounded-full bg-primary flex items-center justify-center border-2 border-card">
              ...
              <div className="flex gap-2">
                ...
                >
                  <div className="relative">
                    ...
                    <span className="absolute -top-0.5 -end-0.5 w-2 h-2 bg-white rounded-full animate-ping" />
                  </div>
                  <span>رد</span>
                </Button>
