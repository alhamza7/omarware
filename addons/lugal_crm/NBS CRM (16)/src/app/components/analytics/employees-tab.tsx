            ...
            <table className="w-full text-xs">
              <thead>
                <tr className="border-b border-border/40 bg-muted/20">
                  <th className="text-start p-3 min-w-[160px]">الموظف</th>
                  <th className="text-start p-3 cursor-pointer hover:text-primary transition-colors" onClick={() => toggleSort("totalMessages")}>
                    <div className="flex items-center gap-1">الرسائل <SortIcon field="totalMessages" /></div>
                  </th>
                  <th className="text-start p-3">المكالمات</th>
                  <th className="text-start p-3 cursor-pointer hover:text-primary transition-colors" onClick={() => toggleSort("frtMinutes")}>
                    <div className="flex items-center gap-1">FRT <SortIcon field="frtMinutes" /></div>
                  </th>
                  <th className="text-start p-3 cursor-pointer hover:text-primary transition-colors" onClick={() => toggleSort("ttrHours")}>
                    <div className="flex items-center gap-1">TTR <SortIcon field="ttrHours" /></div>
                  </th>
                  <th className="text-start p-3">التأخيرات</th>
                  <th className="text-start p-3 cursor-pointer hover:text-primary transition-colors" onClick={() => toggleSort("conversionsOrders")}>
                    <div className="flex items-center gap-1">التحويلات <SortIcon field="conversionsOrders" /></div>
                  </th>
                  <th className="text-start p-3 cursor-pointer hover:text-primary transition-colors" onClick={() => toggleSort("satisfactionScore")}>
                    <div className="flex items-center gap-1">الرضا <SortIcon field="satisfactionScore" /></div>
                  </th>
                  <th className="text-start p-3 cursor-pointer hover:text-primary transition-colors" onClick={() => toggleSort("kpiScore")}>
