            ...
            <table className="w-full text-xs">
              <thead>
                <tr className="border-b border-border/40 bg-muted/20">
                  <th className="text-start p-3">الوكيل</th>
                  <th className="text-start p-3">التفاعلات</th>
                  <th className="text-start p-3">المحلولة</th>
                  <th className="text-start p-3">نسبة الحل</th>
                  <th className="text-start p-3">FRT</th>
                  <th className="text-start p-3">رضا العملاء</th>
                </tr>
              </thead>
              <tbody>
