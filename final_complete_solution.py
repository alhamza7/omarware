...
def create_sap_data_final():
    """الحل النهائي الكامل: إنشاء بيانات SAP"""
    try:
        ...
        print("=== الحل النهائي الكامل: إنشاء بيانات SAP ===")
        ...
        # 2. Get default UoM ID with proper JSON handling
                ...
                if existing:
                    ...
                    cur.execute("""
                        INSERT INTO product_template (
                            name, type, uom_id, uom_po_id, create_uid, write_uid, create_date, write_date
                        ) VALUES (%s, %s, %s, %s, %s, %s, NOW(), NOW())
                        RETURNING id;
                    """, (f'{{"en_US": "{product_name}"}}', 'product', default_uom_id, default_uom_id, 2, 2))
