...
def create_sap_data_final_working():
    """الحل النهائي العامل: إنشاء بيانات SAP"""
    try:
        ...
        print("=== الحل النهائي العامل: إنشاء بيانات SAP ===")
                ...
                if existing:
                    ...
                    cur.execute("""
                        INSERT INTO product_template (
                            name, type, uom_id, service_tracking, tracking, create_uid, write_uid, create_date, write_date
                        ) VALUES (%s, %s, %s, %s, %s, %s, %s, NOW(), NOW())
                        RETURNING id;
                    """, (f'{{"en_US": "{product_name}"}}', 'product', default_uom_id, 'no', 'none', 2, 2))
...
if __name__ == "__main__":
    success = create_sap_data_final_working()
    if success:
        print("\n🎉 تمت المزامنة بنجاح!")
